...
require github.com/nickwells/param.mod/v5 v5.15.7

require (
	github.com/nickwells/check.mod/v2 v2.1.7 // indirect
...
require (
	...
	github.com/nickwells/errutil.mod v1.2.8 // indirect
	github.com/nickwells/filecheck.mod v1.1.18 // indirect
	...
	github.com/nickwells/twrap.mod v1.4.21 // indirect
